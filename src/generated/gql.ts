 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation deleteBlogPost($id: ID!) {\n  blogMutations {\n    deleteBlogPost(id: $id) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"): (typeof documents)["mutation deleteBlogPost($id: ID!) {\n  blogMutations {\n    deleteBlogPost(id: $id) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation updateBlogPost($id: ID!, $input: BlogPostInput!) {\n  blogMutations {\n    updateBlogPost(id: $id, input: $input) {\n      __typename\n      ... on QuerySuccess {\n        message\n        id\n      }\n      ... on StandardError {\n        message\n      }\n    }\n  }\n}"): (typeof documents)["mutation updateBlogPost($id: ID!, $input: BlogPostInput!) {\n  blogMutations {\n    updateBlogPost(id: $id, input: $input) {\n      __typename\n      ... on QuerySuccess {\n        message\n        id\n      }\n      ... on StandardError {\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query wikipediaPage($title: String!) {\n  wikiQueries {\n    wikipediaPage(title: $title)\n  }\n}"): (typeof documents)["query wikipediaPage($title: String!) {\n  wikiQueries {\n    wikipediaPage(title: $title)\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
